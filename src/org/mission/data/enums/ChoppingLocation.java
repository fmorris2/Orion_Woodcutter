...
public enum ChoppingLocation {
    ...
    W_VARROCK_WEST_1(new Area(new int[][]{
            ...
            {3157, 3387},
            {3157, 3417}
    }), false, false, 10, TreeType.NORMAL, TreeType.OAK),
    W_VARROCK_WEST_2(new Area(new int[][]{
            ...
            {3153, 3381},
            {3161, 3389}
    }), false, false, 12, TreeType.NORMAL),
    W_VARROCK_WEST_3(new Area(new int[][]{
            {3133, 3415},
            {3146, 3415},
            {3152, 3395},
            {3140, 3391}
    }), false, false, 8, TreeType.NORMAL, TreeType.OAK),
    W_VARROCK_WEST_4(new Area(new int[][]{
            ...
            {3117, 3436},
            {3116, 3418}
    }), false, false, 12, TreeType.NORMAL, TreeType.OAK),
    W_VARROCK_WEST_5(new Area(new int[][]{
            {3148, 3466},
            {3173, 3465},
            {3173, 3446},
            {3148, 3445}
    }), false, false, 6, TreeType.NORMAL),
    W_VARROCK_WEST_6(new Area(new int[][]{
            ...
            {3190, 3366},
            {3197, 3374}
    }), false, false, 6, TreeType.NORMAL, TreeType.OAK),
    W_VARROCK_SOUTH_1(new Area(new int[][]{
            {3240, 3373},
            {3241, 3355},
            {3276, 3357},
            {3276, 3375}
    }), false, false, 16, TreeType.NORMAL, TreeType.OAK, TreeType.YEW),
    ...
    W_VARROCK_SOUTH_4(new Area(new int[][]{
            ...
            {3233, 3329},
            {3223, 3331}
    }), false, false, 2, TreeType.NORMAL, TreeType.OAK),
    ...
    W_VARROCK_EAST_3(new Area(new int[][]{
            ...
            {3269, 3459},
            {3261, 3466}
    }), false, false, 18, TreeType.NORMAL, TreeType.OAK, TreeType.YEW),
    ...
    W_VARROCK_EAST_5(new Area(new int[][]{
            ...
            {3243, 3519},
            {3252, 3496}
    }), false, false, 15, TreeType.NORMAL, TreeType.OAK, TreeType.YEW),
    ...
    W_VARROCK_PALACE_1(new Area(new int[][]{
            ...
            {3252, 3470},
            {3246, 3470}
    }), false, false, 20, TreeType.YEW),
    W_VARROCK_PALACE_2(new Area(new int[][]{
            {3225, 3507},
            {3226, 3495},
            {3202, 3497},
            {3201, 3506}
    }), false, false, 10, TreeType.YEW),
    ...
    W_BARBARIAN_VILLAGE_1(new Area(new int[][]{
            ...
            {3039, 3414},
            {3033, 3444}
    }), false, false, 15, TreeType.EVERGREEN),
    ...
    W_FALADOR_NORTH_1(new Area(new int[][]{
            ...
            {2972, 3413},
            {2950, 3422}
    }), false, false, 14, TreeType.NORMAL, TreeType.EVERGREEN),
    W_FALADOR_NORTH_2(new Area(new int[][]{
            {2947, 3425},
            {2964, 3406},
            {2958, 3397},
            {2941, 3396}
    }), false, false, 14, TreeType.NORMAL, TreeType.OAK),
    W_FALADOR_NORTH_3(new Area(new int[][]{
            {2985, 3423},
            {2985, 3411},
            {3014, 3411},
            {3014, 3426}
    }), false, false, 13, TreeType.NORMAL, TreeType.EVERGREEN, TreeType.OAK),
    W_FALADOR_NORTH_4(new Area(new int[][]{
            {3009, 3421},
            {3009, 3392},
            {3042, 3389},
            {3041, 3408}
    }), false, false, 15, TreeType.NORMAL, TreeType.OAK),
    W_FALADOR_1(new Area(new int[][]{
            ...
            {2982, 3376},
            {2985, 3380}
    }), false, false, 3, TreeType.NORMAL, TreeType.OAK),
    W_FALADOR_2(new Area(new int[][]{
            ...
            {3041, 3342},
            {3034, 3341}
    }), false, false, 5, TreeType.NORMAL, TreeType.OAK),
    W_CRAFTING_GUILD_1(new Area(new int[][]{
            ...
            {2908, 3304},
            {2909, 3319}
    }), false, false, 10, TreeType.NORMAL, TreeType.OAK, TreeType.WILLOW),
    ...
    W_RIMMINGTON_NORTH_1(new Area(new int[][]{
            ...
            {2924, 3216},
            {2917, 3238}
    }), false, true, 14, TreeType.NORMAL, TreeType.OAK, TreeType.YEW),
    W_RIMMINGTON_NORTH_2(new Area(new int[][]{
            ...
            {2945, 3238},
            {2939, 3224}
    }), false, true, 10, TreeType.NORMAL, TreeType.OAK),
    W_RIMMINGTON_NORTH_3(new Area(new int[][]{
            ...
            {2966, 3248},
            {2964, 3234}
    }), false, true, 8, TreeType.NORMAL, TreeType.OAK),
    W_RIMMINGTON_SOUTH_1(new Area(new int[][]{
            ...
            {2972, 3207},
            {2971, 3211}
    }), false, true, 14, TreeType.NORMAL, TreeType.OAK, TreeType.WILLOW),
    ...
    W_RIMMINGTON_SOUTH_3(new Area(new int[][]{
            ...
            {2992, 3180},
            {2984, 3182}
    }), false, true, 14, TreeType.NORMAL, TreeType.WILLOW),
    ...
    W_PORT_SARIM_WEST_3(new Area(new int[][]{
            ...
            {2995, 3264},
            {3002, 3260}
    }), false, true, 18, TreeType.NORMAL, TreeType.OAK),
    ...
    W_FALADOR_SOUTH_2(new Area(new int[][]{
            ...
            {2943, 3308},
            {2950, 3309}
    }), false, false, 20, TreeType.NORMAL, TreeType.OAK),
    W_FALADOR_SOUTH_3(new Area(new int[][]{
            ...
            {3005, 3320},
            {2994, 3315}
    }), false, false, 20, TreeType.NORMAL, TreeType.OAK, TreeType.YEW),
    ...
    W_PORT_SARIM_NORTH_3(new Area(new int[][]{
            ...
            {3062, 3273},
            {3056, 3260}
    }), false, true, 15, TreeType.NORMAL, TreeType.OAK, TreeType.YEW),
    W_PORT_SARIM_NORTH_4(new Area(new int[][]{
            {3064, 3256},
            {3064, 3249},
            {3056, 3249},
            {3055, 3255}
    }), false, true, 14, TreeType.WILLOW),
    ...
    W_DRAYNOR_VILLAGE_EAST_1(new Area(new int[][]{
            ...
            {3103, 3254},
            {3097, 3255}
    }), false, false, 4, TreeType.NORMAL, TreeType.OAK),
    ...
    W_DRAYNOR_VILLAGE_SOUTH_1(new Area(new int[][]{
            ...
            {3079, 3236},
            {3082, 3245}
    }), false, false, 15, TreeType.WILLOW),
    ...
    W_LUMBRIDGE_WEST_7(new Area(new int[][]{
            ...
            {3154, 3260},
            {3153, 3266}
    }), false, false, 8, TreeType.NORMAL, TreeType.OAK, TreeType.WILLOW),
    W_LUMBRIDGE_WEST_8(new Area(new int[][]{
            ...
            {3183, 3285},
            {3164, 3287}
    }), false, false, 8, TreeType.NORMAL, TreeType.WILLOW),
    W_RIVER_LUM_1(new Area(new int[][]{
            ...
            {3158, 3341},
            {3167, 3342}
    }), false, false, 10, TreeType.NORMAL),
    ...
    W_LUMBRIDGE_EAST_1(new Area(new int[][]{
            ...
            {3214, 3241},
            {3222, 3248}
    }), false, false, 5, TreeType.NORMAL, TreeType.WILLOW),
    ...
    ChoppingLocation(Area area, boolean members, boolean should_use_deposit_box, int capacity, TreeType... tree_type) {
        this.AREA = area;
