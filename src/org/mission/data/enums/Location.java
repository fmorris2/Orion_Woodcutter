...
public enum Location {
    ...
    VARROCK_WEST_1(new Area(new int[][]{
            ...
            {3157, 3387},
            {3157, 3417}
    }), false, TreeType.NORMAL, TreeType.OAK),
    ...
    ), false, TreeType.NORMAL, TreeType.OAK, TreeType.YEW),
    ...
    ), false, TreeType.NORMAL, TreeType.EVERGREEN),
    ...
    FALADOR_NORTH_3(new Area(new int[][]{
            ...
            {3014, 3411},
            {3014, 3426}
    }), false, TreeType.NORMAL, TreeType.EVERGREEN, TreeType.OAK),
    ...
    CRAFTING_GUILD_1(new Area(new int[][]{
            ...
            {2908, 3304},
            {2909, 3319}
    }), false, TreeType.NORMAL, TreeType.OAK, TreeType.WILLOW),
    ...
    RIMMINGTON_SOUTH_3(new Area(new int[][]{
            ...
            {2992, 3180},
            {2984, 3182}
    }), false, TreeType.NORMAL, TreeType.WILLOW),
    ...
    Location(Area area, boolean members, TreeType... tree_type) {
        this.AREA = area;
